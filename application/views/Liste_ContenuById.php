        ...
        <div class="row">
            <div class="col-lg-8 mb-5 mb-lg-0">
                ...
                <?php 
                    ...
                    <!-- <h1 class="blog-head" style="color: #2d2d2d";>Fiche: <?php echo $liste[$i]['Nom']; ?></h1> -->
                    ...
                    <article class="blog_item">
                        ...
                        <div class="blog_details">
                            <a class="d-inline-block" href="blog_details.html">
                                <h1 class="blog-head" style="color: #2d2d2d;"><?php echo $liste[$i]['Categorie']; ?> : <?php echo $liste[$i]['Nom']; ?></h1>
                            </a>
